...
try:
	...
	while True:
		...
		if lastFileId == fileId:
			...
			t.sleep(2)
			continue
		args_vmmsdat = ['../build/convertFile', '-f', "./" + name, '-vmm', '[[[0,0,0,0],[0,1,0,1]', '-bc', '40', '-tac', '60', '-th','0', '-cs','1', '-ccs', '3', '-dt', '3000', '-mst', '1', '-spc', '55000', '-dp', '27500', '-coin', 'center-of-masss', '-crl', '0.2', '-cru', '10', '-save', '[[0],[0],[0]]', '-algo', '6', '-info', '', '-df','VTC']
